...
//BlockchainIterator an iterator will be created each time we iterate over blocks in a blockchain and it’ll store the block hash of the current iteration and a connection to a DB
